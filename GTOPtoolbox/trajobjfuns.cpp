...
double jupiter1(const vector<double>& x, std::vector<double>& rp)
{
	const int DIM = 2;
...
double jupiter2(const vector<double>& x, std::vector<double>& rp)
{
	...
	problem.e  = 0.99;      // Final orbit eccentricity
	problem.rp = 600'000;   // Final orbit pericenter
	problem.DVlaunch = 0;   // Launcher DV
